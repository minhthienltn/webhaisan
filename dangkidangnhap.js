function dangky(){
    ...
    if(tendangnhap.length==0){
        thanhcong=false;
        document.getElementById("tendangnhap").innerText="Tên đăng nhập không được để trống";
    }
    if(password==""){
        thanhcong=false;
        document.getElementById("password").innerText="Mật khẩu không được để trống";
    }
    ...
    if(number==""){
        thanhcong=false;
        document.getElementById("number").innerText="Số điện thoại không được để trống";
    }
    if(diachinha==""){
        thanhcong=false;
        document.getElementById("diachigiaohang").innerText="Địa chỉ giao hàng không được để trống";
    }
